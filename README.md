...
**_You must first install and configure [GAM by Jay Lee](https://github.com/jay0lee/GAM)_**. I have included the installer for Gam and python in the [Release](https://github.com/strohmy86/GAM/releases "Releases").
